  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "12px", marginBottom: "16px" }}>
      <div style={{ background: "white", border: "1px solid #e3e9f1", borderRadius: "8px", padding: "14px 16px" }}>
        <div style={{ fontSize: "10px", color: "#718096", fontWeight: 600, marginBottom: "4px" }}>Total Reports</div>
        <div style={{ fontFamily: "Manrope", fontSize: "20px", fontWeight: 700, color: "#132238" }}>{reports.length}</div>
      </div>
      <div style={{ background: "white", border: "1px solid #e3e9f1", borderRadius: "8px", padding: "14px 16px" }}>
        <div style={{ fontSize: "10px", color: "#718096", fontWeight: 600, marginBottom: "4px" }}>High Risk</div>
      ...
      <div style={{ background: "white", border: "1px solid #e3e9f1", borderRadius: "8px", padding: "14px 16px" }}>
        <div style={{ fontSize: "10px", color: "#718096", fontWeight: 600, marginBottom: "4px" }}>This Month</div>
  ...
  return (
    <div className="modal-backdrop" role="presentation" onMouseDown={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal-card" role="dialog" aria-modal="true" style={{ maxWidth: "520px" }}>
        ...
        <p>Full metadata for this report record.</p>
        <div style={{ display: "grid", gap: "12px", marginTop: "8px" }}>
          <DetailRow label="Report ID" value={`#${report.id}`} />
          <DetailRow label="Type" value={formatReportType(report.reportType)} />
          {typeDesc && (
            <DetailRow label="Description" value={typeDesc} />
          )}
